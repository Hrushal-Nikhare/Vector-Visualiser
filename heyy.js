...
function addVector() {
	var startX = parseFloat(document.getElementById("startX").value) || 0;
	var startY = parseFloat(document.getElementById("startY").value) || 0;
	var startZ = parseFloat(document.getElementById("startZ").value) || 0;
	var dirX = parseFloat(document.getElementById("dirX").value) || 0;
	var dirY = parseFloat(document.getElementById("dirY").value) || 0;
	var dirZ = parseFloat(document.getElementById("dirZ").value) || 0;
...
function calculateDistance(vec1, vec2) {
	var dx = vec2.dirX - vec1.dirX;
	var dy = vec2.dirY - vec1.dirY;
	var dz = vec2.dirZ - vec1.dirZ;
...
function calculateAngle(vec1, vec2) {
	...
	return angleRad * (180 / Math.PI) || 0; // Convert radians to degrees
}
